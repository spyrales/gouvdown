...
output: 
  gouvdown::propre_brochure:
    ...
    # la ligne suivante permet de modifier la ligne "Ce document a été réalisé avec le package `gouvdown`"
    # made_with: ""
# la ligne suivante permet l'impression en PDF (Chrome doit être installé)
...
![](https://gitlab-forge.din.developpement-durable.gouv.fr/dreal-pdl/csd/propre.brochure/-/raw/master/images/drawkit-full-stack-man-monochrome.svg)
