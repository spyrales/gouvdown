...
This template is generated through a Github Action for Linux, Windows and MacOS and uploaded as an artifact. This aims at helping to follow the development of `{pagedown}` by providing a visual check.
